...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXplZW1oYWlkZXIiLCJhIjoiY2thZWw2enllMDEyZzJ3cXYzdnE2bGgyYiJ9.XIHQ37MDwA7FJ6GSXn5E3w';
  ...
  map.on('load', function () {
    var a = locations.map(function (loc) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfuly"));
            location.reload(true);
            _context.next = 12;
            break;
...
var stripe = Stripe('pk_test_51H0c2kJs7b80fR8MAAHsAqM9CwAzcs3MwvWJUlj41AtjAhxGWOTn06Tad2VsfmwQQFJeMK3ehrXbGzhfSEhTzmLH00FfRCo4xb'); //
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //charge credit card
